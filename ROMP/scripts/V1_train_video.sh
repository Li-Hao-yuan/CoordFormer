...
CUDA_VISIBLE_DEVICES=0 nohup python -u -m romp.train_video --GPUS=0 --configs_yml='configs/v1_video.yml' > '/data1/lihaoyuan/vomp/log/resnet_3pdw_only_video_g0'.log 2>&1 &

# sh scripts/V1_train_video.sh
# ps -ef|grep configs_yml=configs/v1_video.yml|grep -v grep|cut -c 9-15|xargs kill -9
