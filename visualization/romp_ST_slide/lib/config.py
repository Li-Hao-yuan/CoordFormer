...
def parse_args(input_args=None):
    ...
    transformer_group.add_argument('--src_len',type=int,default=32,help="enc input length")
    transformer_group.add_argument('--tgt_len',type=int,default=32,help="dec input length")
    transformer_group.add_argument('--emb_size',type=int,default=32,help="embedding size")
