...
def parse_args(input_args=None):
    ...
    train_group.add_argument('--force_centermap_loss',type=bool,default=False,help='whether force to get loss of centermap')

    transformer_group = parser.add_argument_group(title='transformer settings')
    transformer_group.add_argument('--src_len',type=int,default=64,help="enc input length")
    transformer_group.add_argument('--tgt_len',type=int,default=64,help="dec input length")
    transformer_group.add_argument('--emb_size',type=int,default=256,help="embedding size")
    transformer_group.add_argument('--forward_dim',type=int,default=1024,help="feedforward dimension")
    ...
    transformer_group.add_argument('--trans_layer',type=int,default=4,help="number of encoder and decoder Layer")
    transformer_group.add_argument('--trans_heads',type=int,default=4,help="number of heads in Multi-Head Attention")
    ...
    eval_group.add_argument('--test_interval',default=6000,help='interval iteration between validation',type=int)
    ...
    log_group.add_argument('--optim_path', type=str, default='', help='trained model path')
