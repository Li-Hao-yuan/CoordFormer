...
def parse_args(input_args=None):
    ...
    parser.add_argument('--renderer', type = str, default = None, help = 'character: pytorch3d / pyrender')
    ...
    eval_group.add_argument('--test_interval',default=2200,help='interval iteration between validation',type=int)
