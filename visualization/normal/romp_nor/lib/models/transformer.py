...
class Transformer(nn.Module):
    def __init__(self):
        ...
        self.encoderl = nn.TransformerEncoder(encoder_layer_w,num_layers=args().trans_layer//2)
        ...
        self.decoderl = nn.TransformerDecoder(decoder_layer_w,num_layers=args().trans_layer // 2)
...
if __name__ == "__main__":
    ...
    import numpy as np
    enc_input = torch.rand((1,64,128,128))
