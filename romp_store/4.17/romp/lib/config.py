...
def parse_args(input_args=None):
    ...
    transformer_group.add_argument('--src_len',type=int,default=512,help="enc input length")
    transformer_group.add_argument('--tgt_len',type=int,default=512,help="dec input length")
    transformer_group.add_argument('--emb_size',type=int,default=128,help="embedding size")
    ...
    transformer_group.add_argument('--trans_heads',type=int,default=6,help="number of heads in Multi-Head Attention")
