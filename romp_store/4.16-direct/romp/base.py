    ...
    def _create_data_loader(self,train_flag=True):
        ...
        if self.distributed_training:
            ...
            return DataLoader(dataset = datasets,\
                ...
                drop_last = True if train_flag else False, pin_memory = True,num_workers = self.nw,shuffle = False)#shuffle = True
        else:
            return DataLoader(dataset = datasets,\
                batch_size = self.batch_size if train_flag else self.val_batch_size, shuffle = False, \
