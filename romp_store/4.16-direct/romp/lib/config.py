...
def parse_args(input_args=None):
    ...
    transformer_group.add_argument('--pre_src_len',type=int,default=512,help="pre enc input length")
    ...
    transformer_group.add_argument('--pre_emb_size',type=int,default=1024,help="embedding size")
    transformer_group.add_argument('--emb_size',type=int,default=80,help="embedding size")
    ...
    transformer_group.add_argument('--paramsmap_conf_thresh', type=float, default=0.25, help='the threshold of the centermap confidence for the valid subject')
