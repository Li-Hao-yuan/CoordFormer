...
class Base(object):
    ...
    def _create_data_loader(self,train_flag=True):
        ...
        if self.distributed_training:
            ...
            return DataLoader(dataset = datasets,\
                ...
                drop_last = True if train_flag else False, pin_memory = True,num_workers = self.nw,shuffle = True)#shuffle = True
        else:
            return DataLoader(dataset = datasets,\
    ...
    def _create_single_data_loader(self, shuffle=False, **kwargs):
        ...
        return DataLoader(dataset = datasets, shuffle=True,batch_size = self.val_batch_size,\
