...
def parse_args(input_args=None):
    ...
    transformer_group.add_argument('--emb_size',type=int,default=1024,help="embedding size")
    ...
    transformer_group.add_argument('--trans_layer',type=int,default=12,help="number of encoder and decoder Layer")
    transformer_group.add_argument('--trans_heads',type=int,default=12,help="number of heads in Multi-Head Attention")
